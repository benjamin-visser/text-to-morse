...
class TestCoding:
    ...
    def test_decoding(self):
        ...
        for encoding_pair in EXAMPLE_ENCODINGS:
            string, code = encoding_pair
            assert coder.decode(code) == string.upper()  # decoder outputs string in uppercase
    ...
    def test_encode_decode(self):
        ...
        for encoding_pair in EXAMPLE_ENCODINGS:
            ...
            assert coder.decode(encoded_string) == string.upper()  # decoder outputs string in uppercase
